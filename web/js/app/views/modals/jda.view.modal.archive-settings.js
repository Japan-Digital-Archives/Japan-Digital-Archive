			...
			'<div class="modal" id="modal-archive-settings">'+
				...
				'<div class="modal-body">'+
					...
					'<div class="control-group">'+
						...
						'<label class="radio"><input name="set" type="radio" value="false" <%= private %>> <span class="label">LIMITED</span> Anyone with a link to your collection can view it. Your collection will not appear in general archive searches or on your public user page.</label>'+
					'</div>'+
