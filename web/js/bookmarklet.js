...
var bm = new bookmarklet({
    css : [getZeegaHost() + "/js/css/zeega.widget.css"],
    	...
    	var zeegaBM = {
	        ...
	        init: function(){
                ...
                { 
                    ...
                    $('#zeega-overlay').append("<iframe id='zeega-widget-iframe' style='padding: 0px; height: 100%; width:470px; height: 100%; border:solid 1px gray' src='http://jdarchive.org/widget?url="+encodeURIComponent(this.url)+"' />").animate({
